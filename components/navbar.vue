<template>
  <div>
    <div class="bg-neutral-400 flex items-center place-content-around">

      <ul class="px-2 py-4  justify-start">
        <li class="px-2 logo_1 justify-start">
          <a href="#"><img src="rajveer.png" /></a>
        </li>
      </ul>
